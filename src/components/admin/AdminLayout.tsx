...
import { LayoutDashboard, ShoppingBag, Package, ChevronLeft, Menu, X } from 'lucide-react';
          ...
          <nav className="p-4 space-y-2">
            <NavLink 
              ...
              className={({ isActive }) => `
                ...
                ${isActive ? 'bg-primary text-primary-foreground' : 'hover:bg-gray-100 text-gray-700'}
              `}
            >
